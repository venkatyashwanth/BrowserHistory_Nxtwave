                ...
                <div className="historypage">
                    <div className="historySearchContainer">
                        ...
                        <div className="searchInputBox">
                            ...
                            <input type="search" placeholder="Search history" onChange={this.handleChange} value={searchInput} />
                        </div>
                    </div>
                        ...
                        <ul className="history-list">
                            {
                                filteredHistory.map(each =>
                                    <HistoryItem key={each.id} historyItems={each} deleteElement={this.handleDelete} />
                                )
                            }
                        </ul>
